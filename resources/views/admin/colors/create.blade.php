...
@section('subtitle')Create Color @endsection
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Create Color</h1>
      {{ Breadcrumbs::render('admin.colors.create') }}
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                      ...
                      {!! Form::open(['method' => 'post', 'action' => 'App\Http\Controllers\Admin\ColorsController@store', 'class' => 'row g-3', 'style' => 'margin-top: 0;']) !!}
