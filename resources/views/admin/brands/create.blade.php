...
@section('subtitle')Create Brand @endsection
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                      ...
                      {!! Form::open(['method' => 'post', 'action' => 'App\Http\Controllers\Admin\BrandsController@store', 'class' => 'row g-3', 'style' => 'margin-top: 0;']) !!}
